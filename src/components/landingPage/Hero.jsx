        ...
        <div className="bg-white rounded-3xl p-6 md:p-8 shadow-xl text-black w-full md:w-[450px]">
          ...
          <div className="flex justify-between mb-6 border border-gray-300 rounded-full overflow-hidden">
            <button
              ...
              className={`w-full py-2 px-4 flex items-center justify-center gap-2 font-semibold text-sm rounded-full transition ${activeTab === 'track' ? 'bg-gray-900 text-white' : 'bg-transparent text-gray-600'
                }`}
            >
